...
class Config:
    ...
    def __init__(self, config_file: str = None):
        ...
        self.fast_llm_model = os.getenv('FAST_LLM_MODEL', "gpt-4-turbo-preview")
        self.smart_llm_model = os.getenv('SMART_LLM_MODEL', "gpt-4-turbo-preview")
        ...
        self.total_words = int(os.getenv('TOTAL_WORDS', 2500))
